...
class solution:
    ...
    def __init__(self):
        ...
        self.policy_one = Policy.from_checkpoint(
            os.path.dirname(os.path.realpath(__file__)) + "<Your Policy Path Here>"
        )
        self.policy_two = Policy.from_checkpoint(
            os.path.dirname(os.path.realpath(__file__)) + "<Your Policy Path Here>"
        )
        self.policy_three = Policy.from_checkpoint(
            os.path.dirname(os.path.realpath(__file__)) + "<Your Policy Path Here>"
        )
    ...
    def compute_action(
        ...
        return (
            0  # Remove this Line and replace the lines below with your implementation
        )
